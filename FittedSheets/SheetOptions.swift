...
public struct SheetOptions {
    ...
    public var transitionDamping: CGFloat = 0.7
    ...
    public var useRubberBandEffect = false
    public var rubberBandDamping: CGFloat = 0.0
    ...
    public init(pullBarHeight: CGFloat? = nil,
        ...
        self.useRubberBandEffect = useRubberBandEffect ?? defaultOptions.useRubberBandEffect
    }
